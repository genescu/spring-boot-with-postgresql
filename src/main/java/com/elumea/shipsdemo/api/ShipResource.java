...
public class ShipResource {
    ...
    public List<Map<Object, Integer>> shipsInPort(@PathVariable long id, @PathVariable String dateTime) {
    ...
    public List<Map<Object, Integer>> shipsInPortSummary(@PathVariable long id, @PathVariable String startTime, @PathVariable String endTime) {
        return shipRepository.findShipsInPortSummary(id, serviceUtils.formatToDate(startTime), serviceUtils.formatToDate(endTime));
    }
